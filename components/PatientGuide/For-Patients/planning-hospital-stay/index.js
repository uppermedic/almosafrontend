...
const Content = ({ t }) => {
  ...
  `,
    en: `
    Before starting the admission procedures, you will receive all necessary information about your stay in the hospital from your doctor, the nurse assigned to care for you, or the patient educator. We at AlMoosa Hospital take care of the details related to the stay of patients in the hospital .
    </br></br>
