export const data = [
  {
    ar: {
      title: `يُطلب من المرضى الوصول قبل نصف ساعة من الموعد المحدد لاستكمال الإجراءات التالية:`,
      content: `
      <ul>
        <li>
        يجب على جميع المرضى التوجه إلى مكتب أمين الصندوق لدفع رسوم الفحص والحصول على إيصال
        </li>
        <li>
        خذ إيصال الدفع إلى مكتب الاستقبال ، حيث سيعد موظف الاستقبال ملفك ، وبعد ذلك يمكنك الذهاب إلى عيادتك أو عيادة الأسنان وانتظار موعدك 
        </li>
        <li>
        سنبذل قصارى جهدنا من أجلك لرؤية الطبيب في موعدك. في حالة حدوث أي تأخير ، سيبلغك موظفونا بالمسألة. إذا وصلت إلى عيادة ، فسيتم إعطاء الأولوية للمرضى الذين حجزوا مواعيدهم مسبقًا.
        </li>
      </ul>
      `
    },
  ...
  {
    ar: {
      title: `حجز مواعيد متابعة المريض`,
      content: `افترض أن حالتك تتطلب حجز موعد إضافي للمراجعة مع الطبيب المختص. في هذه الحالة ، ستسجل الممرضة تاريخ الموعد التالي في بطاقة الموعد بناءً على تعليمات الطبيب المعالج. لذلك ، عليك الذهاب بهذه البطاقة إلى مكتب الاستقبال لإتمام إجراءات حجز المواعيد.`
    },
    en: {
  ...
  },
  {
    ar: {
      title: `إلغاء الموعد`,
      content: `عادة ما تكون هناك قائمة انتظار لأسماء المرضى الذين يحتاجون إلى تحديد موعد في العيادات الخارجية. لذلك ، إذا لم تتمكن من حضور موعدك ، يجب عليك الاتصال بنا قبل يومين على الأقل من تاريخ موعدك لتحديد موعدك لمريض آخر.`
    },
    en: {
  ...
  },
  {
    ar: {
      ...
      content: `قد يطلب منك الطبيب المعالج إجراء فحوصات وإجراءات إضافية فورًا بعد الموعد الطبي ، وستوجهك الممرضة إلى القسم المناسب حيث يمكنك إكمال الفحوصات المطلوبة.
      </br></br>
      إذا كانت هذه الفحوصات عاجلة ، فسيُطلب منك بعد إكمال هذه الفحوصات العودة إلى مكتب الاستقبال في العيادة التي كنت فيها. سيقوم الطبيب المعالج بالبحث معك في نتائج هذه الفحوصات في نفس اليوم ، وإذا لم تكن هذه الاختبارات عاجلاً ، سيتم إيداع نتائج الاختبارات في ملفك. سيناقش الطبيب هذه النتائج معك عندما تلتقي بك في الموعد المقبل.
      `
    },
    en: {
