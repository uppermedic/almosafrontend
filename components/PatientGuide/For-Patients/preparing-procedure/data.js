export const data = {
  ar: {
    title: `نصائح مهمة قبل الإجراءات الطبية:`,
    content: `
    <ul>
      <li>
      قبل الجراحة ، سيقوم طبيبك بإجراء فحص بدني كامل للتأكد من عدم وجود ظروف قد تتداخل مع الجراحة أو النتائج. يقوم عادة بإجراء فحوصات روتينية ، مثل فحوصات الدم والأشعة السينية ، قبل أسبوع من أي عملية جراحية كبرى.
      </li>
      <li>
      ناقش مع طبيبك وطبيب الأسرة أي أدوية تتناولها لتحديد الأدوية التي يجب الامتناع عنها قبل الجراحة.
      </li>
      
      <li>
      ناقش خيارات الاستعداد لنقل الدم المحتمل مع أطبائك ، مثل التبرع بالدم والتدخلات الطبية والعلاجات الأخرى ، قبل الجراحة.
      </li>
      <li>
      إذا كنت تعاني من السمنة ، فإن فقدان الوزن قبل الجراحة يمكن أن يساعد في تقليل الضغط على المفصل الجديد. ومع ذلك ، يجب عدم اتباع نظام غذائي خلال الشهر السابق للجراحة.
      </li>

      <li>
      إذا كنت تتناول الأسبرين ، أو الأدوية المضادة للالتهابات ، أو الوارفارين ، أو أي أدوية تزيد من خطر النزيف ، فيجب عليك إيقافها قبل أسبوع من الجراحة لتقليل النزيف.
      </li>
      <li>
      إذا كنت تدخن ، يجب عليك الإقلاع عن التدخين أو الحد منه لتقليل مخاطر الجراحة وتحسين التعافي والشفاء.

      </li>
      <li>
      عالج أي مشاكل في الأسنان أو اللثة أو المثانة أو الأمعاء قبل الجراحة لتقليل خطر العدوى لاحقًا.
      </li>
      <li>
      اتبع نظامًا غذائيًا متوازنًا يحتوي على مكملات الفيتامينات والحديد.
      </li>

      <li>
      أبلغ جراحك بأي عدوى لديك. لا يمكن إجراء الجراحة حتى تختفي أي حالات مرضية تمامًا.
      </li>
    </ul>
    `
  },
