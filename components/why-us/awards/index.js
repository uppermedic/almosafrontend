...
const data = [
  {
    id: 1,
    en: {
      title: 'Joint Commission International Accreditation- JCIA',
      content: `<a href="https://www.jointcommissioninternational.org">JCIA</a> is an independent, not for profit organization accredits and certify healthcare organizations and programs across the globe. <a href="https://www.jointcommissioninternational.org">JCI</a> accreditation and certification is recognized as a global leader for healthcare quality of care and patient safety.<br/><br/> (ASH) started <a href="https://www.jointcommissioninternational.org">JCI</a> accreditation journey in the year <strong>2009</strong> and successfully achieved the gold seal for <a href="https://www.jointcommissioninternational.org">JCI</a>. Hospital achieved 4 successful accreditations from <a href="https://www.jointcommissioninternational.org">JCI</a>. By implementing <a href="https://www.jointcommissioninternational.org">JCI</a> standard in ASH the patient care become standardized which directly increases patient satisfaction. <br/><br/> ASH is continuously working on implementing most recent evidence-based practice to achieve highest level of care in patient and to improve patient safety and quality of care in the hospital. `
    },
    ar: {
      title: 'اعتماد اللجنة الدولية المشترك JCIA',
      content: `تعتبر اللجنة الدولية المشتركة ممن أرقى الهيئات عالميًا في مجال تقييم مستويات الجودة في المنشآت الصحية ويعتبر اعتمادها من أهم  الاعتمادات العالمية المتخصصة في جودة منشآت الرعاية الصحية <br/><br/>
        فخورون بحصولنا على <a href="https://www.jointcommissioninternational.org">اعتماد اللجنة الدولية المشتركة (JCI)</a> اربع مرات متتالية خلال أعوام <strong>2009</strong> و<strong>2012</strong> و<strong>2015</strong> و <strong>2018</strong>.<br/><br/>
        حيث أقرت اللجنة الدولية المشتركة <a href="https://www.jointcommissioninternational.org">JCI</a> أن مستشفى الموسى التخصصي يلتزم بأعلى المعايير الدولية في مراقبة الجودة وسلامة المرضى<br/><br/>
        يركز الاعتماد  على جودة الرعاية المقدمة  للمرضى، وعلى إدارة المؤسسة والأنظمة الطبية المعمول بها، كما تعمل معايير<a href="https://www.jointcommissioninternational.org"> JCI </a>على تحديد وتقييم الوظائف الرئيسية بالمستشفيات ومؤسسات الرعاية الصحية، وتتضمن هذه الوظائف تحقيق الأهداف العالمية المتعلقة بسلامة المرضى ومكافحة العدوى، والتعليم، وإدارة المعلومات والموارد البشرية، ونُظم إدارة المرافق المختلفة، وكذلك النظم القيادية والإدارية.
      `
    }
  },
  {
  ...
  },
  {
    ...
    en: {
      ...
      content: `<a href="https://planetree.org/certification/about-planetree/">Planetree</a> is an international nonprofit organization that promotes patient-centered care in healthcare. <br/> <br/> Guided by their principles and framework, the hospital embarked on pursuing its <a href="https://planetree.org/certification/about-planetree/">Planetree</a> Journey. It started in the latter part of <strong>2014</strong> and was, later received the recognition of <a href="https://planetree.org/certification/about-planetree/">Planetree</a> Silver Merit Certification for Excellence in Person-Centered Care in <strong>2015</strong>. It was then, in August <strong>2017</strong>, that the hospital achieved the Golden Merit Certification for Excellence in Person-Centered Care and was Re-Certified in the year <strong>2020</strong>.<br/><br/> Being the First Hospital in the Middle East to be awarded as a <a href="https://planetree.org/certification/about-planetree/">Planetree</a> Certified hospital, it continues to provide high-quality service and care to its patients. True to its commitment to employing Person-Centered Care, initiatives have been embedded in the daily practices in the organization. <br/> <br/> Person-Centered Care in Al Moosa Specialist Hospital at a glance <br/> <br/> <a href="/about/awards/golden-designation"><strong>Read more ...</strong></a>`
    },
    ar: {
      title: 'الوسام الذهبي من منظمة Planetree للرعاية المتركزة حول المريض',
      content: `تعتبر <a href="https://planetree.org/certification/about-planetree/">Planetree</a> المنظمة الرائدة حول العالم في تحسين تجربة المرضى ونشر ثقافة التعاطف والانسانية في الرعاية الصحية <br/><br/>
  ...
  },
  {
    ...
    en: {
      ...
      content: `ASH Laboratory won accreditation by the <a href="https://www.cap.org/">American College of Pathologists (CAP)</a> in <strong>2017</strong>. This marked a significant shift in the hospital’s level of patient-centered care by
      ...
      The laboratory has been always keen to be recognized for its implementation of international standards, particularly those measured by the <a href="https://www.cap.org/">CAP</a> team from the United States. 
  `
    },
    ar: {
      title: 'اعتماد المختبر من الكلية الأمريكية لعلوم الأمراض - CAP',
      content: `تعد الكلية الامريكية لعلماء الامراض والتشريح <a href="https://www.cap.org/">(CAP- College of American Pathologists)</a> هي أعلى الجهات العلمية التي تضع معايير الجودة للمختبرات حول العالم <br/> <br/>
  ...
  },
  {
    ...
    ar: {
      ...
      content: `حقق مستشفى الموسى التخصصي بالأحساء انجازًا كبيرًا حيث فاز <a href="https://kaqa.org.sa/"> بجائزة الملك عبد العزيز للجودة</a> في دورتها الرابعة لعام <strong>2018</strong>م، ويُعد المستشفى الخاص الوحيد بالمملكة الذي يفوز بها لاجتيازه المعايير التي حددتها الجائزة. <br/><br/>
  ...
  },
  {
    ...
    en: {
      ...
      content: `Almoosa Specialist Hospital is also accredited by the <a href="https://www.aabb.org/">American Association of Blood Banks</a>, which is granted to blood banks that conform to the AABB standards and are surveyed every two years for administrative and practical organization and quality control.<br/> <br/> The Hospital achieved re-accreditation recently in month Mar 2021`
    },
    ar: {
      title: 'اعتماد بنك الدم من الجمعية الأمريكية AABB',
      content: `تعد الجمعية الأمريكية لبنوك الدم <a href="https://www.aabb.org/">AABB - (American Association of Blood Banks)</a>هي أعلى الجهات العلمية، والأشد صرامة والتي تعنى بمنح الاعتمادات لبنوك الدم داخل الولايات المتحدة الأمريكية وحول العالم . <br/><br/>
  ...
  },
  {
    ...
    ar: {
      ...
      content: ` تعتبر شهادةماجنيت <a href="https://www.nursingworld.org/organizational-programs/magnet">Magnet</a>   أعلى اعتماد  في مجال التمريض  والمصدر الرئيسي لأفضل الممارسات التمريضية في جميع أنحاء العالم <br/><br/>
        بدأنا رحلتنا نحو الحصول على اعتماد <a href="https://www.nursingworld.org/organizational-programs/magnet">Magnet</a>    في عام <strong>2020</strong>  وقطعنا شوطا كبير في تطوير فريق التمريض مهنيا وتحسين الرعاية المقدمة للمرضى <br/><br/>
        نحن نحرص على الحصول على إعتماد الـــ  <a href="https://www.nursingworld.org/organizational-programs/magnet">Magnet</a> لأننا ملتزمون بتقديم رعاية بمعايير عالمية عالية متركزة حول المريض `
    }
  },

  {
    ...
    en: {
      ...
      content: `<a href="https://www.acr.org/">ACR</a> accreditation is recognized as the gold standard in medical imaging.  It helps assure our patients that we provide the highest image quality and safety and that our facility meets equipment, medical personnel, and quality assurance requirements. During the accreditation process, the <a href="https://www.acr.org/">ACR</a> evaluates equipment and staff to promote high standards in all aspects of practice and patient safety. You can rest assured that we offer top-quality services.`
    },
    ar: {
      title: ' اعتماد الكلية الأمريكية للأشعة - ACR',
      content: `تعتبر الكلية الأميركية للأشعة <a href="https://www.acr.org/"> ACR - American College of Radiology </a> ACR أكبر وأقدم هيئة أعتماد للتصوير الطبي. حيث ينتسب اليها أكثر من <strong>34000 </strong>طبيب يعملون على  التأكد من التزام قسم الأشعه  بأعلى المعايير وذلك بإخضاع كل من الأجهزة والطاقم الطبي والفني في القسم لمجموعة من الأختبارات الصارمة
