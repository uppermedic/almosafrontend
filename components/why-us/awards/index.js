...
const data = [
  ...
  },
  {
    ...
    ar: {
      ...
      . <br/><br/> <strong>(ASHP)</strong> هي منظمة مهنية تمثل شؤون الصيادلة في المستشفيات ومؤسسات الصحة ومرافق الرعاية طويلة الأجل والرعاية المنزلية ومكونات الرعاية الصحية الأخرى. <br/> <br/> معايير الاعتماد : <ul> <li>الجودة .</li> <li>سلامة الدواء .</li> <li>القيادة والإدارة .</li> <li>التعليم والتدريب .</li> <li>إدارة المعلومات .</li> <li>الموردين .</li> <li>السياسة الدوائية والمعلومات الدوائية .</li> </ul>`
    }
  },
  {
    id: 15,
