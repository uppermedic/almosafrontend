        ...
        {language === 'en' ? (
          <div className="content">
            ...
            <div className="single-section">
              ...
              <Paragraph paragraph="Help us celebrate the compassion and skills of your fellow extraordinary nurses by nominating them to the DAISY AWARD. <a href='https://www.surveymonkey.com/r/9DC38NY' target='_blank' rel='noopener noreferrer nofollow'>https://www.surveymonkey.com/r/9DC38NY</a> <br/> <a href='www.surveymonkey.com' target='_blank' rel='noopener noreferrer nofollow'>www.surveymonkey.com </a>" />
          ...
          <div className="content">
            ...
            <div className="single-section">
              ...
              <Paragraph paragraph="نحن نبحث عن محترفين..عن ممروضون وممرضات مستعدون لبذل جهدًا إضافيًا لإحداث فرق لمريض أو عائلة أو زميل أو منظمة. نحن نقدر الأفكار الخلاقة ونسعى لجعلها حقيقة، وجودك معنا يعني أنك أصبحت جزءاَ من الحل." />
