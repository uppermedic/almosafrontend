              ...
              {language == 'en' && (
                <div className="content">
                  ...
                  <div className="single-section">
                    ...
                    <Paragraph paragraph="Almoosa’s emblem, the local Sidra tree, symbolizes life and nurturing care for patients, visitors, and the local community. The influences of the Sidra tree are found in the building's gentle curving facade . Throughout the interior architecture, features referencing nature continue to soothe anxiety and reinforce the Almoosa brand ." />
                  ...
                  <div className="single-section">
                    ...
                    <Menu
                      items={[
                        ...
                        {
                          text:
                            'Power of Art: distinguished Selection of local and international artworks, to integrate art in the healing journey .'
                        }
                      ]}
                    />
                  </div>
                  <div className="single-section">
                    ...
                    <Paragraph paragraph="The inpatient pharmacy system will reduce medication errors and improve the quality of care ." />
                  ...
                  <div className="single-section">
                    ...
                    <Menu
                      items={[
                        {
                          text:
                            'The region most favored Bone and Joint Center .'
                        },
                  ...
                  <div className="single-section">
                    ...
                    <Menu
                      items={[
                        ...
                        { text: 'Popliteal artery pseudoaneurysm stenting .' },
                        { text: 'Pelvic congestion syndrome coiling .' },
                        {
                          text: 'Renal artery embolization of Angiomyolipoma .'
                        },
              ...
              {language == 'ar' && (
                <div className="content">
                  ...
                  <div className="single-section">
                    ...
                    <Paragraph paragraph="يرمز شعار مستشفى الموسى 'شجرة السدرة المحلية' إلى الحياة والرعاية الصحية للمرضى والزوار والمجتمع المحلي في الأحساء، يمكن ملاحظة شكل وتأثير شجرة السدرة في مبنى مستشفى الموسى والعمارة الداخلية مما يشير إلى الطبيعة ويساعد في تخفيف التوتر وتعزيز علامة الموسى التجارية ." />
                  ...
                  <div className="single-section">
                    ...
                    <Menu
                      items={[
                        ...
                        { text: 'معمل قسطرة ومختبرات تصوير الأوعية .' },
                        {
                          text:
                  ...
                  <div className="single-section">
                    <Title title="مراكز التميز والبرامج الطبية" />
                    <Menu
                      items={[
                        ...
                        {
                          text:
                            'مركز علم الأعصاب ويقدم برنامج متكامل لإدارة السكتة الدماغية .'
                        },
                        {
                          text:
                  ...
                  <div className="single-section">
                    <Title title="كان لنا السبق في المنطقة الشرقية و المملكة في إجراء :" />
                    <Menu
                      items={[
                        { text: 'الملاحة العصبية في عمليات العمود الفقري .' },
                        {
                          text:
                            'حج القحف اليقظ أو ما يسمي باللغة الدارجة "استئصال ورم الدماغ أثناء اليقظة" .'
                        },
                        { text: 'جراحة عبر المريء .' },
                        { text: 'أول TAVR .' },
                        { text: 'أول تنظير للمفاصل بتقنية النانوسكوبي .' },
                        {
                          text: 'جراحة تنظير قاعدة الجمجمة الوتدي عبر الأنف .'
                        },
                        ...
                        {
                          text:
                            'استخدام تقنية العلاج الكيماوي بالتسخين الحراري لاستئصال أورام البطن .'
                        },
                        ...
                        {
                          text:
                            'لأول مرة في الاحساء توفر خدمة تصوير القلب بالرنين المغناطيسي .'
                        }
                      ]}
                    />
                  </div>
